        ...
        child: Stack(
          ...
          children:[
            ...
            const Column(
              ...
              children: [
                SizedBox(height :500,),
                Text("ASLABTIF", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: Color(0xff1B1B1B),)),
                Text("TRAVEL", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: Color(0xff1B1B1B),)),
              ]
            )
          ]
        ),
